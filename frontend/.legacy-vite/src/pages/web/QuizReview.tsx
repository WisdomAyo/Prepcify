  ...
  return (
    <div className="max-w-4xl">
      <PageHeader
        ...
        actions={
          <Link to="/app/quiz/results" className="rounded-full bg-foreground px-5 py-2 text-sm font-semibold text-background">
            See summary →
          </Link>
        }
      />
              ...
              <div className="flex items-start gap-4">
                <div
                  className={cn(
                    ...
                    right ? "bg-success text-success-foreground" : "bg-destructive text-destructive-foreground"
                  )}
                >
                  {right ? <Check className="h-5 w-5" /> : <X className="h-5 w-5" />}
                </div>
                ...
                <button className="text-xs font-semibold text-accent flex items-center gap-1 shrink-0">
