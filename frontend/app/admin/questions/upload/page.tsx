    ...
    <div className="max-w-3xl">
      <PageHeader
        ...
        actions={
          <Link
            ...
            className="flex items-center gap-2 rounded-full bg-secondary px-5 py-2 text-sm font-semibold"
          >
      ...
      <div className="rounded-3xl border-2 border-dashed border-border bg-card p-12 text-center">
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Max 5,000 rows · 20 MB
        </p>
        <button className="mt-5 rounded-full bg-accent px-6 py-2.5 text-sm font-semibold text-accent-foreground">
          Choose file
        </button>
      </div>
      ...
      <div className="mt-6 rounded-2xl border border-border bg-card p-5">
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1">
            <p className="text-sm font-semibold">CSV template</p>
            <p className="text-xs text-muted-foreground">
              Required columns: exam, year, subject, topic, difficulty, stem,
              opt_a, opt_b, opt_c, opt_d, correct, explanation
            </p>
          </div>
          <button className="rounded-full bg-secondary px-4 py-1.5 text-xs font-semibold">
            Download
          </button>
        </div>
      </div>
