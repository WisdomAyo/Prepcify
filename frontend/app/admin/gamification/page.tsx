  ...
  return (
    <div className="max-w-5xl">
      <PageHeader
        eyebrow="Admin"
        title="Gamification"
        description="Tune XP rules and design new badges."
      />
      ...
      <div className="grid gap-5 md:grid-cols-2">
        ...
        <div className="rounded-3xl border border-border bg-card p-6">
          <div className="mb-4 flex items-center justify-between">
            ...
            <button className="flex items-center gap-1.5 rounded-full bg-accent px-4 py-1.5 text-xs font-semibold text-accent-foreground">
