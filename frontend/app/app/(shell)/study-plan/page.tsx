    ...
    <div className="max-w-6xl">
      ...
      <div className="mb-6 grid gap-4 sm:grid-cols-3">
        <div className="rounded-2xl border border-border bg-card p-5">
          ...
          <p className="font-display text-3xl font-bold">12 days</p>
        </div>
        <div className="rounded-2xl border border-border bg-card p-5">
          <p className="text-xs text-muted-foreground">Avg session</p>
          <p className="font-display text-3xl font-bold">38 min</p>
        </div>
        <div className="rounded-2xl bg-foreground p-5 text-background">
          <p className="text-xs text-background/60">Adherence</p>
          <p className="font-display text-3xl font-bold text-accent">92%</p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-5 gap-2 sm:grid-cols-7 lg:grid-cols-10">
          {days.map((d) => (
            <div
              key={d.day}
              className={cn(
                "flex aspect-square flex-col items-center justify-center rounded-xl border-2 p-2 text-center",
            ...
            >
              ...
              {d.today && (
                <p className="mt-1 text-[9px] font-semibold uppercase text-accent">
                  Today
                </p>
              )}
            </div>
