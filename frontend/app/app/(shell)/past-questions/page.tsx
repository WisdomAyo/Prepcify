...
export default function PastQuestionsExamsPage() {
  return (
    <div className="max-w-6xl">
      ...
      <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-3">
        {exams.map((e) => (
          ...
          >
            <div
              className={`flex h-14 w-14 items-center justify-center rounded-2xl text-lg font-bold ${e.color}`}
            >
              {e.name.slice(0, 2)}
            </div>
